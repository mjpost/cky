...
#define HASH_CODE(HASH, HASH_KEY, HASH_VALUE, KEY_HASH, KEY_NEQ, KEY_COPY,  \
		  KEY_FREE, NULL_KEY, NULL_VALUE, VALUE_FREE)		\
	\
...
{									\
  struct HASH ## it hit = {(HASH_KEY) NULL_KEY, (HASH_VALUE) NULL_VALUE, ht, NULL, 0}; \
...
#define HASH_CODE_ADD(HASH, HASH_KEY, HASH_VALUE, KEY_HASH, KEY_NEQ,    \
		      KEY_COPY, KEY_FREE, NULL_KEY, NULL_VALUE, VALUE_FREE) \
								        \
